...
class Coin3Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val v: View = inflater.inflate(R.layout.fragment_coin3, container, false)
        ...
        val c3 = v.findViewById<ImageView>(R.id.icon_coin3)
        ...
        v.findViewById<FloatingActionButton>(R.id.floatingClick).setOnClickListener {
            ...
            c3.setImageDrawable(inflater.context.getDrawable(R.drawable.wer))
            math1 = 0
            math2 = 0
            math3 = 0
        }
        ...
        c1.setOnClickListener {
            if (math1 == 0) {
                ...
                math3 = floor(Math.random() * 3).toInt()

                setImgCoins(c1, math1)
                setImgCoins(c2, math2)
                setImgCoins(c3, math3)
            }
        }
